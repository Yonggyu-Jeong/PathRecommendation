package com.example.shareonfoot.HTTP;
...
import com.example.shareonfoot.HTTP.Session.interceptor.AddCookiesInterceptor;
import com.example.shareonfoot.HTTP.Session.interceptor.ReceivedCookiesInterceptor;
...
public class APIAdapter {
    ...
    protected static Object retrofit(Context context, Class<?> serviceName) {
        ...
        Gson gson = new GsonBuilder()
                .setLenient()
         //       .setDateFormat("MM dd, yyyy, HH:mm:ss Z")
                .create();
