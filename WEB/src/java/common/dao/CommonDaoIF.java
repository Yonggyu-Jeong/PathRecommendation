...
public interface CommonDaoIF {
	 ...
	 * @return
	 */
	public abstract ABoxList<ABox> selectList(String key, ABoxList<ABox> aBoxList);
	 ...
	 * @return
	 */
	public abstract int insert(String key, ABoxList<ABox> aBoxList);
	 ...
	 * @return
	 */
	public abstract int delete(String key, ABoxList<ABox> aBoxList);
