...
public class CommonDaoImpl extends SuperDao implements CommonDaoIF {
	 ...
	 * 
	 * @param key  mybatis의 xml 문서 id값
	 * @param aBoxList SQL 파라미터
	 * @return
	 */
	public ABoxList<ABox> selectList(String key, ABoxList<ABox> aBoxList) {
		List<Object> list = sqlSessionTemplate.selectList(key, aBoxList);
		return new ABoxList<ABox>(list);
	}
	...
	public int delete(String key, ABoxList<ABox> aBoxList) {
		return sqlSessionTemplate.delete(key, aBoxList);
	}
